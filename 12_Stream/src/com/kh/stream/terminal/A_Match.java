...
/*
 * 매칭 : 최종 처리 단계에 요소들이 특정 조건에 만족하는지 조사하는 역할
...
//		a.method1();
	...
	public void method2() {
		...
		// 나이가 10살 이상한 학생들이 모두 여자인지 확인하시오.
		// 남학생들 중에 평균이 70점 이상인 학생이 한 명이라도 존재하는지 확인하시오.
		
		result = students.stream().filter(student -> student.getAge() >= 10).allMatch(student -> student.equals("여자"));
		System.out.println(result);
