...
public class A_Variable {
	...
	public void printValue() {
		...
		// 변수를 사용하지 않으면
		System.out.println(10 * 2 * 3.141592); // 원의 둘레 = 2 x 반지름 x 3.141592
	...
	public void VariableTest() {
		 ...
		 * [표현법] 자료형 변수명;
		 * 
		 * - 자료형은 어떤 값을 저장할지, 어떤 크기에 메모리를 할당받을지에 대한 정보이다.
...
//		ch = 'ab'; // 에러 발생
		...
		short sNum; // 2byte
		int iNum;   // 4byte (기본 인식 값)
		long lNum;  // 8byte
		
//		bNum = 128; // 에러 발생 -> 오버플로우(Overflow)
		lNum = 92233726984L; // 숫자 뒤에 L 또는 l을 입력해야 한다.
		
		// 실수형
		float fNum;  // 4byte
		double dNum; // 8byte (기본 인식 값)
		...
		int NUMBER;
		int Number;
//		Stirng number; // 자료형이 달라도 변수명이 같으면 에러 발생
