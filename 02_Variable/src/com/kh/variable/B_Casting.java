...
//		b.autoCasting();
	...
	public void casting() {
		double d = 4.12345678904567890; // 소수점 15자리까지만 표현 가능
		float f = (float)d;  // 소수점 6자리까지만 표현 가능
		...
		System.out.println(bNumber2);  // 127 찍으면 다시 -128로 넘어감
