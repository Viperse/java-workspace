...
public class Application {
	 ...
	 * - 접근 제한자는 public, (default) 로 설정 가능
	...
	public static void main(String[] args) {
		 ...
		 * - 객체의 주소값을 참조 타입인 변수에 저장에서 객체 사용
		 */
		
		// 객체 생성 = 메모리에 올린다 = 객체의 구성 요소가 다 올라간다 (Field, Method)
		Tv tv = new Tv();
