 ...
 *   -> Object 클래스에서 제공하는 메소드들을 오버라이딩하며 메소드 재정의가 가능
...
public class Notebook extends Product { /*extends Object*/
	...
	public Notebook(String brand, String pCode, String name, int price, String cpu) {
		// 부모 멤버변수를 초기화할 수 있는 방법
		// super : 해당 객체의 부모의 객체 주소를 담고 있음
		...
		*/
		 ...
		 *    - 부모 클래스에서 setter 메소드를 제공하면 자식 객체에서 부모의 setter 메소드를 통해서 필드의 초기화 가능
