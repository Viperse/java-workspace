 ...
 * 논리적 에러(logic error) : 실행은 되지만, 의도와는 다르게 동작
 * 
 * <런타임 에러 2가지>
...
public class A_TryCatch {
	 ...
	 * }]
	 * 
	 * - printStackTrace() : 예외발생 당시의 호출스택(Call Stack)에 있었던 메소드의 정보와 예외 메시지를 화면에 출력
	 * - getMemssage() : 발생한 예외클래스의 인스턴스에 저장된 메시지를 얻을 수 있음
	 */
