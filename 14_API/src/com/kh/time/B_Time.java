...
//		b.method3();
	...
	public void method1() {
		...
		System.out.println("시간 : " + now.getMinute());
		...
		System.out.println("widthDays : " + withDays);
	...
	public void method2() {
		...
		pe = pe.plusYears(3).multipliedBy(2);  // 3년을 더하고, 2배로 곱한다
	...
	public void method3() {
		...
		/*
		 * DateTimeFormatter
		 * - 날짜와 시간을 포맷팅(Formatting)된 문자열로 변환하는 메소드를 제공하는 클래스
		 */
