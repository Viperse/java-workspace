 ...
 * - 기본 자료형으로 사용해도 되지만 해당 기본 타입을 객체로 취급해서 처리해야 하는 경우 사용 Integer.paseInt
 * - Boxing : 기본 자료형을 Wrapper 클래스로 포장해 주는 것
 * - UnBoxing : Wrapper 클래스를 기본 자료형으로 변경해 주는 것
 */
...
//		b.method1();
	...
	public void method1() {
		...
		System.out.println("dNum2 == double : " + (dNum2 == double2));  // true
		System.out.println("double1 == double2 : " + (double1 == double2));  // false
		
		// 클래스에서 제공하는 메소드들을 사용할 수 있음
		System.out.println("equals : " + double1.equals(double2));
		
		System.out.println();
		
		// 2. 객체를 직접 생성하지 않고 정적 메소드(valueOf)를 통한 방법
		...
		// 자바 1.9 버전 이후로는 Boxing이나 UnBoxing 기능을 안 쓰도록 Deprecated 되어 있음
