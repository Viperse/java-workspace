...
//		f.practice1();
	 ...
	 * 두 정수의 곱셈 결과가 100보다 크거나 같은 경우 "결과가 100 이상입니다" 아닌 경우 "결과가 100보다 작습니다" 출력
	 */
	...
	public void practice1() {
		...
		Scanner sc = new Scanner(System.in);
		System.out.print("첫 번째 정수 값을 입력해 주세요 : ");
		int num1 = sc.nextInt();
		
		System.out.print("두 번째 정수 값을 입력해 주세요 : ");
		int num2 = sc.nextInt();
	 ...
	 * 문제 2
	 * 
	 * 사용자한테 문자를 하나 입력받아서 입력한 문자가 대문자이면 "알파벳 대문자이다." 아니면 경우 "알파벳 대문자가 아니다." 출력
	 */
