...
//		System.out.println(score); // [I@3d012ddd
	...
	public void method2() {
		...
		int[] score2;
		// score2 = {100, 90, 80, 70, 60} // 이건 안 됨!
		
		// 문자열.length(), 배열.length <- 주의! () 있는 것은 메소드 없는 것은 변수
	...
	public void method3() {
		 ...
		 * - 증감식을 사용하지 않고 배열 및 컬렉션의 요소 개수만큼 반복하고for문 종료
		 */
	...
	public void method5() {
		...
		System.out.println(Arrays.toString(number)); // 배열의 값을 반환
		...
		System.out.println(number.hashCode()); // 객체를 식별할 하나의 정수 값
		System.out.println(copy.hashCode());
		System.out.println(copy.hashCode() == number.hashCode()); // true
	}
...
//		System.out.println(copy.length); // NullPointeExeption
