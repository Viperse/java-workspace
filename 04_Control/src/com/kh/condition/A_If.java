...
//			System.out.println("축하드려요!");
	...
	public void method3() {
		...
		System.out.println("김도경" == name); // false
		System.out.println("김도경".equals(name)); // true, String 클래스의 equals) 메소드
		System.out.println("김도경".charAt(0)); // String 클래스의 charAt(0) 메소드
	...
	public void method4() {
		...
		// 0보다 크면 "양수", 그게 아니면 "음수", 0일 때는 "0입니다"
...
//			System.out.println("음수");
	...
	/*
	 * 사용자에게 점수(0~100)을 입력받아서 점수별로 등급을 출력하라 - 90점 이상은 A등급 - 90점 미만 80점 이상은 B등급 - 80점
	 * 미만 70점 이상은 C등급 - 70점 미만 60점 이상은 D등급 - 60점 미만 F 등급
	 */
	public void method6() {
